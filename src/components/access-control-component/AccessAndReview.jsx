  ...
  return (
    ...
    navigate("/add-new-employee", {
      ...
      <div className="mb-4 flex items-center gap-3">
        ...
        <button className="flex items-center gap-4 rounded-lg border px-4 py-2 text-sm">
          Filter by Role <FilterIcon className="w-4" />
        </button>
        <button className="flex items-center gap-4 rounded-lg border px-4 py-2 text-sm">
            ...
            <tr className="text-sm text-gray-600">
              <th className="px-4 py-3">
                <div className="flex items-center gap-2">
                  User’s Name <FilterIcon className="w-4" />
                </div>
              </th>
              <th className="">
                <div className="flex items-center gap-2">
                  Email <FilterIcon className="w-4" />
                </div>
              </th>
              <th className="">
                <div className="flex items-center gap-2">
                  Role <FilterIcon className="w-4" />
                </div>
              </th>
              <th className="">
                <div className="flex items-center gap-2">
                  Permissions <FilterIcon className="w-4" />
                </div>
              </th>
              <th></th>
            </tr>
  ...
  return (
    <div className="rounded-2xl border bg-white p-6">
      ...
      <div className="mt-6 rounded-lg bg-blue-50 px-4 py-3 text-sm text-blue-700">
        <strong>Note:</strong> Tasks are auto-created each quarter for directory
        owners. Reviews verify access is still needed, scopes are appropriate,
        and temporary access has been revoked.
      </div>
    </div>
  );
}
