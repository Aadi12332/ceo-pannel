const PageHeader = ({ title, description, filter, actions = [] }) => {
  return (
    <div className="w-full flex lg:flex-row flex-col items-center justify-between gap-5 mb-5">
      <div>
        ...
        <div className="flex items-center gap-4">
          {actions.map((action, index) => (
            <button
              ...
              className={`flex items-center gap-2 px-5 lg:h-[62px] h-12 rounded-lg text-[18px] font-medium transition
                ${
